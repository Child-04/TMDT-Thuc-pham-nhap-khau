...
export const CompletedOrder = (orderId) => async (dispatch, getState) => {
  try {
    const {
      userSignin: { userInfo },
    } = getState();
    ...
    const { data } = await axios.put(
      `${BASE_URL}/order/completed/${orderId}`,
      {
        headers: {
          Authorization: `Bearer ${userInfo.token}`,
        },
    ...
    dispatch({ type: "COMPLETED_ORDER", payload: data });
  } catch (error) {
  }
};
...
export const getOrderPenddingByUser = (idUser) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${BASE_URL}/order/orderPendding/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
...
export const getOrderShippingByUser = (idUser) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${BASE_URL}/order/orderShipping/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
...
export const getOrderCompleteByUser = (idUser) => async (dispatch, getState) => {
  try {
    const {
      userSignin: { userInfo },
    } = getState();
    const { data } = await axios.get(`${BASE_URL}/order/orderComplete/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
    dispatch({ type: "GET_ORDER_COMPLETED_BY_USER", payload: data });
  } catch (error) {
  }
};
export const getOrderPaidByUser = (idUser) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${BASE_URL}/order/orderPaid/${idUser}`, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`,
      },
    });
